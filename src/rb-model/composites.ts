...
// full-precision component values. Composites are internal and never feed EFO.

import { HORIZON_WEIGHTS } from '@/rb-model/constants';
import type { ComponentScores, Horizon, HorizonComposites } from '@/rb-model/types';

const COMPONENT_KEYS: (keyof ComponentScores)[] = ['WRK', 'OQ', 'RE', 'RU', 'TC', 'RD', 'AD', 'AV'];
